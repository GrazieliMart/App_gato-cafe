...
ProductCard(
 ...
 bottomNavigationBar: BottomNavigationBar(
  backgroundColor: Color.fromARGB(255, 255, 255, 255), // cor de fundo aqui
  currentIndex: 0, // aqui vc pode controlar dinamicamente com setState
  onTap: (i) {
  ...
  selectedItemColor: Colors.red, // cor do texto ativo
  unselectedItemColor: Colors.black54, // cor do texto inativo
  items: [
    BottomNavigationBarItem(
      icon: Image.asset(
        "../assets/images/home.png",
        height: 24,
        color: Colors.black54, // cinza quando inativo
      ),
      activeIcon: Image.asset(
        "../assets/images/home.png",
        height: 24,
        color: Colors.red, // vermelho quando ativo
      ),
      label: 'Início',
    ),
    BottomNavigationBarItem(
